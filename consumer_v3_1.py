# consumer Nr1 que solo imprime los mensajes recibidos y borra de la cola
import os
...
print("Consumer 1 está listo para recibir mensajes...")
while True:
        ...
        for topic_partition, messages in msg.items():
            for message in messages:
                try:
                    ...
                    data = message.value
                    print(f"Consumer 1 recibió el mensaje: {data}")
                    ...
                    consumer.commit()
                    print("Consumer 1 ha procesado y confirmado el mensaje.")
